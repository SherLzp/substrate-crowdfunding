...
use substrate_crowdfunding_runtime::{self, opaque::Block, GenesisConfig, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	substrate_crowdfunding_runtime::api::dispatch,
	substrate_crowdfunding_runtime::native_version,
	include_bytes!("../runtime/wasm/target/wasm32-unknown-unknown/release/substrate_crowdfunding_runtime_wasm.compact.wasm")
);
