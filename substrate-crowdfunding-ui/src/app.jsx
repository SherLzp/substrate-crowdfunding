...
import {
	...
	addressBook, secretStore, metadata, nodeService, bytesToHex, hexToBytes, AccountId, BlockNumber, Balance, Hash, VecU8
} from 'oo7-substrate';
...
export class App extends ReactiveComponent {
	constructor() {
        ...
        addCodecTransform('Funding<Hash,AccountId,Balance,BlockNumber>',{
            funding_id: 'Hash',
            manager: 'AccountId',
            project_name: 'Vec<u8>',
        ...
        addCodecTransform('Request<Hash,Balance,BlockNumber>',{
            request_id: 'Hash',
            funding_id: 'Hash',
            purpose: 'Vec<u8>',
            cost: 'Balance',
...
class CrowdFundingSegment extends React.Component {
    constructor() {
        super()
